...
// Initialize the ODR so that NSS is high and SCK is low. It does not matter what MOSI is set to.
//===========================================================================
void setup_bb(void)
{
...
//C subroutine named init_spi2() that initializes the SPI2 subsystem and connects
//its NSS, SCK, and MOSI signals to pins PB12, PB13, and PB15, respectively.
//You should set these pins to use the alternate functions to do this. (10)
...
void init_spi1() {
    ...
    SPI1->CR1 |= (7 << 3); //set br to be 111
    SPI1->CR2 = 0x0900; //configure interface for 10-bit word size
...
void spi1_setup_dma(void)
{
    ...
    DMA1_Channel3->CPAR = 0x4001300c; //spi1->dr 0x0c spi1 offset 0x40013000
    ...
    DMA1_Channel3->CCR &= ~(DMA_CCR_PINC); //says in debugging portion
    ...
    NVIC->ISER[0] = 1 << 10; //dma_ch2_3 position
