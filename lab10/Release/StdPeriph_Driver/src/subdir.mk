...
StdPeriph_Driver/src/%.o: ../StdPeriph_Driver/src/%.c
	...
	@echo $(PWD)
	arm-none-eabi-gcc -mcpu=cortex-m0 -mthumb -mfloat-abi=soft -DSTM32 -DSTM32F0 -DSTM32F091RCTx -DSTM32F091 -DUSE_STDPERIPH_DRIVER -I"/home/shay/a/dpenebac/workspace/lab10/StdPeriph_Driver/inc" -I"/home/shay/a/dpenebac/workspace/lab10/inc" -I"/home/shay/a/dpenebac/workspace/lab10/CMSIS/device" -I"/home/shay/a/dpenebac/workspace/lab10/CMSIS/core" -O3 -Wall -fmessage-length=0 -ffunction-sections -c -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
